          ...
          {Object.entries(skillCategories).map(([key, category]) => (
            <motion.button
              ...
              style={{
                ...
                backgroundColor: activeCategory === key ? category.color : 'rgba(30, 41, 59, 0.5)',
                border: `1px solid ${activeCategory === key ? category.color : 'rgba(245, 158, 11, 0.2)'}`,
                borderRadius: '0.75rem',
                color: activeCategory === key ? 'white' : '#cbd5e1',
                fontWeight: '600',
                cursor: 'pointer',
              ...
              whileHover={{ 
                scale: 1.05,
                backgroundColor: activeCategory === key ? category.color : 'rgba(245, 158, 11, 0.1)'
              }}
              whileTap={{ scale: 0.95 }}
            >
              {category.icon}
